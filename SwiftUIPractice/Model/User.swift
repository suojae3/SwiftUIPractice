...
extension User {
    static var MOCK_USERS: [User] = [
        ...
        .init(id: NSUUID().uuidString, userName: "Suojae3", profileImageUrl: "Sessac", fullname: "Suojae33", bio: "Hi I'm an iOS developer who loves to read", email: "suojae3@naver.com"),
